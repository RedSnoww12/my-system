...
export default function AuthPage() {
  ...
  const handleGoogle = async () => {
    if (!isFirebaseConfigured) {
      setError(
        'Firebase non configuré. Continue sans compte ou renseigne .env.local.',
      );
      return;
    }
    setBusy(true);
  ...
  return (
    <div className="auth">
      <div className="auth-title brand brand-g">Kripy</div>
      <div className="auth-sub">Precision Lab</div>
